...
enc_flag = ""
enc_flag = [int(i) for i in b64decode(enc_flag).decode().split(",")][::-1]
key = "acscpass"

o = [(enc_flag[i] ^ ord(key[i % len(key)])) for i in range(len(enc_flag))]
c = o[:len(o) - 3][::-1]
eqp = o[len(o) - 3:len(o)]
ciphertext = int.from_bytes(bytes(c), byteorder='big')

p_arr = [0x9940435684b6dcfe5beebb6e03dc894e26d6ff83faa9ef1600f60a0a403880ee166f738dd52e3073d9091ddabeaaff27c899a5398f63c39858b57e734c4768b7, 
...
q_arr = [0xd4aa1036d7d302d487e969c95d411142d8c6702e0c4b05e2fbbe274471bf02f8f375069d5d65ab9813f5208d9d7c11c11d55b19da1132c93eaaaba9ed7b3f9b1, 
